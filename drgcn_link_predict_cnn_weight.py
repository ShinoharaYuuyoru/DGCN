...
def main(args):
    ...
    model_state_file = 'drgcn_'+args.dataset+'_model_state_maxpool_bugfixed.pth'
    forward_time = []
    backward_time = []
...
if __name__ == "__main__":
    ...
    parser.add_argument("--graph_batch_size", type=int, default=5000, help="Number of edges to sample in each iteration.")
